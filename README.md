...
## Publishing a public GitHub repo

1. Create an empty public repo under your org (MIT).
2. Copy this directory as the root of that repo (or `git subtree split`).
3. Push `main`. Do not include the private generator implementation.
